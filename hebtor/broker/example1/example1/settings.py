...
SECRET_KEY = '1m#pw3rw8n%$kbk819c79-oq+8i4^xa)qn1+p7je4vk72)j+6#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_PATH = os.path.expanduser("~/.hebtor")
hidden_service_hostname_path = os.path.join(ROOT_PATH, "onion_service", "hostname")


def load_hidden_address():
    try:
        with open(hidden_service_hostname_path, "r") as f:
            ad = f.read().strip()
            print(ad)
            return ad
    except Exception as e:
        print("load_hidden_address failed")
